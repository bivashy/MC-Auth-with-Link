...
public class VKUtils {
    ...
    public static String getPhotoAttachment(File file) {
        try {
            ...
            SaveMessagesPhotoResponse savePhotoResponse =
                    VK.photos().saveMessagesPhoto(ACTOR, photoUploadResponse.getPhoto()).server(photoUploadResponse.getServer()).hash(photoUploadResponse.getHash()).execute().get(0);
