...
public interface AccountFactory {
	...
	public static final Long DEFAULT_TELEGRAM_ID = (long) -1;
	...
	Account createAccount(String id, IdentifierType identifierType, UUID uuid, String name, HashType hashType,
			String password, String googleKey, Integer vkID, boolean vkConfirmationEnabled, Long telegramId,
			boolean telegramConfirmationEnabled, long lastQuit, String lastIp, long lastSessionStart, long sessionTime);
	...
	default Account createAccount(String id, IdentifierType identifierType, UUID uuid, String name, HashType hashType,
		...
		return createAccount(id, identifierType, uuid, name, hashType, password, googleKey, vkID, vkConfirmationEnabled,
				DEFAULT_TELEGRAM_ID, DEFAULT_TELEGRAM_CONFIRMATION_STATE, lastQuit, lastIp, lastSessionStart,
				sessionTime);
	}
	...
	default Account createAccount(String id, IdentifierType identifierType, UUID uuid, String name, HashType hashType,
		...
		return createAccount(id, identifierType, uuid, name, hashType, password, DEFAULT_GOOGLE_KEY, vkId,
				vkConfirmationEnabled, DEFAULT_LAST_QUIT, DEFAULT_IP, DEFAULT_LAST_SESSION_START, sessionTime);
	}

	default Account createAccount(String id, IdentifierType identifierType, UUID uuid, String name, HashType hashType,
			String password, String googleKey, Integer vkId, long sessionTime) {
		return createAccount(id, identifierType, uuid, name, hashType, password, googleKey, vkId,
				DEFAULT_VK_CONFIRMATION_STATE, DEFAULT_LAST_QUIT, DEFAULT_IP, DEFAULT_LAST_SESSION_START, sessionTime);
	}
	...
	default Account createAccount(String id, IdentifierType identifierType, UUID uuid, String name, HashType hashType,
		...
		return createAccount(id, identifierType, uuid, name, hashType, password, DEFAULT_GOOGLE_KEY, DEFAULT_VK_ID,
				DEFAULT_VK_CONFIRMATION_STATE, DEFAULT_LAST_QUIT, DEFAULT_IP, DEFAULT_LAST_SESSION_START, sessionTime);
	}

	default Account createAccount(String id, IdentifierType identifierType, UUID uuid, String name, HashType hashType,
			long sessionTime) {
		return createAccount(id, identifierType, uuid, name, hashType, DEFAULT_PASSWORD, DEFAULT_GOOGLE_KEY,
				DEFAULT_VK_ID, DEFAULT_VK_CONFIRMATION_STATE, DEFAULT_LAST_QUIT, DEFAULT_IP, DEFAULT_LAST_SESSION_START,
				sessionTime);
	}
}