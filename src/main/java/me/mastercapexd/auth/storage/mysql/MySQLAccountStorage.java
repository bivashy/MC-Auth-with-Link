...
public class MySQLAccountStorage extends SQLAccountStorage {
	...
	private static final String UPDATE_ID = "INSERT INTO `auth` (`id`, `uuid`, `name`, `password`,`google_key`,`vkId`,`vk_confirmation_enabled`,`telegram_id`,`telegram_confirmation_enabled`, `last_quit`, `last_ip`, `last_session_start`, `id_type`, `hash_type`) VALUES "
